...
describe("Queue Service", () => {
    ...
    describe("Loop Mode", () => {
        it("Loops the queue when no more videos are upcoming", async () => {
            ...
            await queueService.loopPlaylist(box)

            expect(await QueueItemModel.count({ box: '9cb763b6e72611381ef043e8', startTime: null, endTime: null })).to.equal(5)
        })
    })
})
