...
import unbanVideo from "./../../../../src/services/BoxService/actions/unban-video.action"
const BoxSchema = require("./../../../../src/models/box.model")

describe.only("Unban Video Action", () => {
    before(async () => {
        await Video.create({
    ...
    it("Unmarks a video for skip", async () => {
        await unbanVideo.execute('9cb763b6e72611381ef043e8', '9cb763b6e72611381ef043f2')
        ...
        expect(targetVideo.ignored).to.equal(false)
    })
})
