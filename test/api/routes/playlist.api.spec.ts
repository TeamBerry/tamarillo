...
describe("Playlists API", () => {
    ...
    describe("Lists playlists", () => {
        it("Returns the list of all public playlists if there's no JWT", () => supertest(expressApp)
            .get('/')
            .expect(200)
            .then(response => {
    ...
    describe("Gets a playlist", () => {
        it("Sends a 401 if trying to get a private playlist without authorization", () => supertest(expressApp)
    ...
    describe("Stores a playlist", () => {
        it("Sends a 401 if an attempt is made without authorization", () => supertest(expressApp)
            .post('/')
            .expect(401, 'UNAUTHORIZED'))
    ...
    describe("Adds a video from a playlist", () => {
        it("Sends a 401 if the JWT is not provided", () => supertest(expressApp)
    ...
    describe("Deletes a playlist", () => {
        it("Sends a 401 if trying to delete a private playlist without authorization", () => supertest(expressApp)
