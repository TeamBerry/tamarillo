 ...
 */
module.exports.publicOrPrivateWithSubscription = async (request: Request, response: Response, next: NextFunction) => {
 ...
 */
module.exports.openOnly = async (_: Request, response: Response, next: NextFunction) => {
    const matchingBox = response.locals.box
...
module.exports.publicOnly = async (_: Request, response: Response, next: NextFunction) => {
    const matchingBox = response.locals.box
